...
void DeprecatedSpace::generateCoordinates()
{
...
void DeprecatedSpace::generateSpeeds()
{
...
void DeprecatedSpace::generate2DRectangle(int xshift, int yshift, int xsize, int ysize, int type, int xspeed /*= 0*/, int yspeed /*= 0*/)
{
	//hardcoded settings
	const int NX = xsize;
	const int NY = ysize;
...
void DeprecatedSpace::generate3DRectangle(int xshift, int yshift, int zshift, 
...
void DeprecatedSpace::initializeUnderspaces()
{
...
void DeprecatedSpace::toUnderspaces()
{
	for (auto &i : underspaces)
		for (auto &j : i)
			for (auto &k : j)
...
DeprecatedSpace::DeprecatedSpace(int width, int height, int n)
...
DeprecatedSpace& DeprecatedSpace::operator=(const DeprecatedSpace&& s)
{
...
void DeprecatedSpace::saveCoordinatesAndSpeeds(const QString& filename)
{
	mutex.lock();
	QFile file(filename);
...
void DeprecatedSpace::saveTrajektory()
{
...
void DeprecatedSpace::loadStateCS(const QString& filename)
{
	mutex.lock();
	QFile file(filename);
...
CUDASpace* DeprecatedSpace::toCUDA() const
{	
...
void DeprecatedSpace::fromCuda(CUDASpace *cs)
{
...
void DeprecatedSpace::generate2DWall()
{
	//hardcoded settings
	int xshift = 80;
	int yshift = 30;
...
void DeprecatedSpace::generate2DBall()
{
	//hardcoded settings
	const int xshift = 0;
